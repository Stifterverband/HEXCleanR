...
Für einen bestimmten Branch oder Commit kann das Argument `ref`
verwendet werden:
...
Ein erneuter Aufruf aktualisiert das Paket auf die aktuelle Version. Mit
`force = TRUE` erzwingst du eine Neuinstallation.
